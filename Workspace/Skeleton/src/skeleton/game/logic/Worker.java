...
public class Worker extends Movable {
    ...
    /**
     * Elbusztítja a játékost és csökkenti a munkások számát egyel.
     */
    @Override
    public void die() {
     ...
     * @param d irény, melybe a munkást a másik munkás tolja
     */
    @Override
    ...
    /**
     * A munkás irányításáért felelõs metódus. A paraméterként kapott irányba
