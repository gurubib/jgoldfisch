...
/**
 * Az egyszerű mezőt reprezentáló osztály. A Field absztrakt
...
public class SimpleField extends Field {
	...
	/**
	 * A mezőre egy Box lép.
	 * Ez az osztály fel van készítve minden eshetőségre:
	 * állhat már rajta Worker, Box, vagy lehet üres is.
	 * @param b A mezőre lépő Box referenciája.
	 * @param d A mezőre lépő Box lépésének iránya.
	 */
	@Override
	public Movable boxEnters(Box b, Direction d) {
		...
		// A felhasználó által megadott Movable referencia (vagy semmi) beállítása a mezőre.
		switch (answer) {
			case "b" : 
				Box b2 = new Box();
				b2.setField(this);
		...
		this.setMovable(b);
		b.place(this);
		//Az érkező Box referenciájának kitörlése arról a mezőről, ahonnan jött.
	...
	/**
	 * A mezőre egy Worker lép.
	 * Ez az osztály fel van készítve minden eshetőségre:
	 * állhat már rajta Worker, Box, vagy lehet üres is.
	 * @param w A mezőre lépő Worker referenciája.
	 * @param d A mezőre lépő Worker lépésének iránya.
	 */
	@Override
	public Movable workerEnters(Worker w, Direction d) {
		...
		this.setMovable(w);
		w.place(this);
		// Az érkező Worker referenciájának kitörlése arról a mezőről, ahonnan jött.
